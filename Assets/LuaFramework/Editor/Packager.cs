...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("equip" + AppConst.ExtName, "*.prefab", "Assets/MyResources/UI");

        AddBuildMap("public_asset" + AppConst.ExtName, "*.png", "Assets/UISourceTexture/Atlas/public");
        AddBuildMap("public_ex_asset" + AppConst.ExtName, "*.png", "Assets/UISourceTexture/Atlas/public_ex");
    }
