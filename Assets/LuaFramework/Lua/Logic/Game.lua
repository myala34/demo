...
function Game.OnInitOK()
    ...
    CtrlManager.Init();
    local ctrl = CtrlManager.GetCtrl(CtrlNames.Equip);
    logWarn("Del AppConst ExampleMode")
    if ctrl ~= nil then --and AppConst.ExampleMode == 1 then
        ctrl:Awake();
    end
